...
/**
 * Write a description of class CharacterCanvas here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class CharacterCanvas extends Actor
{
    ...
    public CharacterCanvas(int width, int height,int col, int row)
    {
        this(width,height);
        this.numCol = col;
        this.numRow = row;
